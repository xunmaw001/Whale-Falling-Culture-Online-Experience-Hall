        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="邮箱">
		     <template slot-scope="scope">
				...
				<el-button v-if="isAuth('yonghu','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-no-smoking" size="mini" @click="banned(scope.row.id)">{{ contents.tableBtnFont == 1?'禁言':'' }}</el-button>
                <el-button v-if="isAuth('yonghu','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="banned(scope.row.id)">{{ contents.tableBtnFont == 1?'禁言':'' }}<i class="el-icon-delete el-icon--right" /></el-button>
                <el-button v-if="isAuth('yonghu','删除') && contents.tableBtnIcon == 0" type="success" size="mini" @click="banned(scope.row.id)">{{ contents.tableBtnFont == 1?'禁言':'' }}</el-button>
                
				<el-button v-if="isAuth('yonghu','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="primary" icon="el-icon-smoking" size="mini" @click="qxbanned(scope.row.id)">{{ contents.tableBtnFont == 1?'取消禁言':'' }}</el-button>
				<el-button v-if="isAuth('yonghu','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="primary" size="mini" @click="qxbanned(scope.row.id)">{{ contents.tableBtnFont == 1?'取消禁言':'' }}<i class="el-icon-delete el-icon--right" /></el-button>
				<el-button v-if="isAuth('yonghu','删除') && contents.tableBtnIcon == 0" type="primary" size="mini" @click="qxbanned(scope.row.id)">{{ contents.tableBtnFont == 1?'取消禁言':'' }}</el-button>
